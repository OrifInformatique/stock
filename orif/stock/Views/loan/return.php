<form class="container" method="post" enctype="multipart/form-data">
    ...
    <div class="form_title">
        ...
        <div class="inventory_nb">

        </div>
    </div>

    <label for="loan_to_user_id"><?= lang('MY_application.field_loan_to_user'); ?> :&nbsp;</label>
    <select class="form-control" name="loan_to_user_id" disabled>
        <option value=""></option>
    ...
    <input class="form-control" name="borrower_email" value="<?php if(isset($borrower_email)) {echo $borrower_email;} ?>" disabled/><br />
    
    <label for="item_localisation"><?= lang('MY_application.header_loan_localisation'); ?> :&nbsp;</label>
    <input class="form-control" name="item_localisation" value="<?php if(isset($item_localisation)) {echo $item_localisation;} else {echo set_value('item_localisation');} ?>" disabled/><br />
    
    <label for="loan_by_user"><?= lang('MY_application.header_loan_by_user'); ?> :&nbsp;</label>
    <input class="form-control" name="loan_by_user" value="<?php if(isset($loan_by_user)) {echo $header_loan_by_user['username'];} ?>" disabled/><br />

    <label for="date"><?= lang('MY_application.header_loan_date'); ?> :&nbsp;</label>
    <input class="form-control" name="date" type="date" value="<?php if(isset($date)) {echo $date;} else {echo set_value('date', date(config('\Stock\Config\StockConfig')->database_date_format));} ?>" disabled/><br />

    <label for="planned_return_date"><?= lang('MY_application.header_loan_planned_return'); ?> :&nbsp;</label>
    <input class="form-control" name="planned_return_date" type="date" value="<?php if(isset($planned_return_date)) {echo $planned_return_date;} ?>" disabled/><br />
