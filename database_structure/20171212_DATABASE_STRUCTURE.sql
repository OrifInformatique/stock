...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 12 déc. 2017 à 15:57
...
--
ALTER TABLE `item_tag`
  MODIFY `item_tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT pour la table `item_tag_link`
--
ALTER TABLE `item_tag_link`
  MODIFY `item_tag_link_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
--
