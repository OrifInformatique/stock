...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 15 juin 2018 à 16:28
...
--
ALTER TABLE `item`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=489;
--
...
--
ALTER TABLE `item_tag`
  MODIFY `item_tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT pour la table `item_tag_link`
--
ALTER TABLE `item_tag_link`
  MODIFY `item_tag_link_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=283;
--
...
--
ALTER TABLE `stocking_place`
  MODIFY `stocking_place_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
