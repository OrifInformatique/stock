...
class Add_Item extends \CodeIgniter\Database\Migration
{
    ...
    public function up()
    {
        ...
        $this->forge->addColumn('item', 'CONSTRAINT fk_item_condition_id FOREIGN KEY (item_condition_id) REFERENCES item_condition (item_condition_id)');
        $this->forge->addColumn('item', 'CONSTRAINT fk_item_group_id FOREIGN KEY (item_group_id) REFERENCES item_group (item_group_id)');
        $this->forge->addColumn('item', 'CONSTRAINT fk_supplier_id FOREIGN KEY (supplier_id) REFERENCES supplier (supplier_id)');
        $this->forge->addColumn('item', 'CONSTRAINT fk_stocking_place_id FOREIGN KEY (stocking_place_id) REFERENCES stocking_place (stocking_place_id)');
