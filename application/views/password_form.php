    ...
    <div class="row">
        <form id="change_password">
            <div class="form-group">
                ...
                <input id="old_password" name="old_password" type="password" class="form-control" value="<?php echo set_value('old_password'); ?>">
            ...
            <div class="form-group">
                ...
                <input id="new_password" name="new_password" type="password" class="form-control" value="<?php echo set_value('new_password'); ?>">
            ...
            <div class="form-group">
                ...
                <input id="confirm_password" name="confirm_password" type="password" class="form-control" value="<?php echo seT_value('confirm_password'); ?>">
