<form class="container" method="post" enctype="multipart/form-data">
	...
	<input class="form-control" name="planned_return_date" type="date" value="<?php if(isset($planned_return_date)) {echo $planned_return_date;} else {echo set_value('date');} ?>" /><br />
