<form class="container" method="post" enctype="multipart/form-data">
	...
	<input class="form-control" name="planned_return_date" type="date" value="<?php if(isset($date)) {echo $date;} else {echo set_value('date');} ?>" /><br />
	...
	<a class="btn btn-default" href="<?php echo base_url() . "item/view/" . $item_id; ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
</form>
