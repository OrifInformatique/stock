<div class="container">
  ...
  <em><?php echo $this->lang->line('delete_tag_ok_start'); echo $name; echo $this->lang->line('delete_tag_ok_end'); ?></em>
  ...
  <div class="alert alert alert-danger">
    <em><?php echo $this->lang->line('delete_tag_notok_start'); echo $name; echo $this->lang->line('delete_tag_notok_end'); echo "<br>"; echo $this->lang->line('delete_tag_notok_confirm'); ?></em>
  </div>
  <div class="btn-group col-xs-12">
    <a href="<?php echo base_url().uri_string()."/confirmed";?>" class="btn btn-danger btn-lg">Oui</a>
    <a href="<?php echo base_url()."admin/view_tags/";?>" class="btn btn-lg">Non</a>
