...
// This part of the GeoLine is for Update
	...
	<form method="post">
		...
		<div class="form-group">
			<label for="user_type_id">Statut :</label>
		...
		<div class="form-group">
			<label for="pwd">Mot de passe<?php if ($update_user) { ?> (vide: ne rien changer)<?php } ?> :</label>
			<input class="form-control" name="pwd" id="pwd" type="password" value="<?php echo set_value('pwd'); ?>" placeholder="Au moins 6 caractères" />
		</div>
		<div class="form-group">
			<label for="pwdagain">Confirmer le mot de passe :</label>
