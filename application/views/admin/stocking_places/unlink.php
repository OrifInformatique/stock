<div class="container">
    <div class="row">
        <h3>
            ...
            <a href="<?= base_url(); ?>admin/view_generic/stocking_place" class="tab_selected"><?= lang('admin_tab_stocking_places'); ?></a>
    ...
    <div class="row">
        <?= lang('admin_unlink_stocking_place_verify').'"'.$name.'" ?'; ?>
    </div>
    <div class="btn-group row" >
        <a href="<?= base_url().uri_string()."/confirmed";?>" class="btn btn-danger btn-lg"><?= lang('text_yes'); ?></a>
        <a href="<?= base_url()."admin/delete_stocking_place/".$stocking_place_id;?>" class="btn btn-lg"><?= lang('text_no'); ?></a>
    </div>
</div>