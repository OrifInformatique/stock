		...
		<div class="clsfilter">
			...
			<a href="<?php echo base_url()."item/" ?>" target="_parent"><button>Effacer filtre</button></a>
			...
			<a href="<?php echo base_url()."item/search" ?>" target="_parent"><button>Rechercher</button></a>
			</form>
		...
		<div class="clsview">
			...
			<div style="font-size:1.0em"><p><?php if(isset($message)){ echo $message; }?></p></div>
