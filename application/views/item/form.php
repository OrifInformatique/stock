...
<form class="container" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="number" id="buying_price" name="buying_price" min="0" step="0.05" value="<?php echo set_value('buying_price'); ?>" /><br />

            <label for="buying_date"><?php echo $this->lang->line('field_buying_date'); ?> :&nbsp;</label>
            <input type="date" id="buying_date" name="buying_date" value="<?php echo set_value('buying_date', date('Y-m-d')); ?>" onblur="change_warranty()" /><br />
        </div>
        <div class="col-md-4">
            <label for="warranty_duration"><?php echo $this->lang->line('field_warranty_duration'); ?> :&nbsp;</label>
            <input type="number" id="warranty_duration" name="warranty_duration" min="0" max="1000" value="<?php echo set_value('warranty_duration', 24); ?>" onblur="change_warranty()" /> mois<br />
