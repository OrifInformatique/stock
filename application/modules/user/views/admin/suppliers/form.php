...
<form class="container" method="post">
  <div class="row" >
    ...
    <a class="btn btn-danger" href="<?= base_url() . "user/admin/view_suppliers/"; ?>"><?= lang('btn_cancel'); ?></a>    
  </div>
  ...
  <div class="row" >
    <h3>
      ...
      <a href="<?= base_url(); ?>user/admin/view_suppliers" class="tab_selected"><?= lang('admin_tab_suppliers'); ?></a>
