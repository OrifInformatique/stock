<div class="container" id="content">
  <div class="row">
    <a href="<?= base_url(); ?>user/admin/new_user/" class="btn btn-success"><?= lang('btn_new'); ?></a>
  </div>
  
  <div class="row">
    <h3>
      <a href="#" onclick="loadPage('user/admin/view_users/')" class="tab_selected"><?= lang('admin_tab_users'); ?></a>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php foreach ($users as $user) { ?>
                    <tr class="row">
                        <td>
                                <a href="<?= base_url('user/admin/modify_user').'/'.$user->user_id ?>" style="display:block"><?= html_escape($user->username); ?></a>
                        </td>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('user/admin/delete_user').'/'.$user->user_id ?>"
