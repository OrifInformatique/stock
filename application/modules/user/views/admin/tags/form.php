...
<form class="container" method="post">
  <div class="row" >
    ...
    <a class="btn btn-danger" href="<?= base_url() . "user/admin/view_tags/"; ?>"><?= lang('btn_cancel'); ?></a>    
  </div>
    
  <div class="row" >
    <h3>
      <a href="<?= base_url(); ?>user/admin/view_users" class="tab_unselected"><?= lang('admin_tab_users'); ?></a>
      <a href="<?= base_url(); ?>user/admin/view_tags" class="tab_selected"><?= lang('admin_tab_tags'); ?></a>
