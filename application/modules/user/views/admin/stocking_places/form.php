...
<form class="container" method="post">
  <div class="row" >
    ...
    <a class="btn btn-danger" href="<?= base_url() . "user/admin/view_stocking_places/"; ?>"><?= lang('btn_cancel'); ?></a>    
  </div>
  ...
  <div class="row" >
    <h3>
      ...
      <a href="<?= base_url(); ?>user/admin/view_stocking_places" class="tab_selected"><?= lang('admin_tab_stocking_places'); ?></a>
