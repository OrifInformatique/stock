<div class="container" id="content">
  <div class="row">
    <a href="<?= base_url(); ?>user/admin/new_stocking_place/" class="btn btn-success"><?= lang('btn_new'); ?></a>
  </div>
    
  <div class="row">
    <h3>
      <a href="#" onclick="loadPage('user/admin/view_users/')" class="tab_unselected"><?= lang('admin_tab_users'); ?></a>
      <a href="#" onclick="loadPage('user/admin/view_tags/')" class="tab_unselected"><?= lang('admin_tab_tags'); ?></a>
      <a href="#" onclick="loadPage('user/admin/view_stocking_places/')" class="tab_selected"><?= lang('admin_tab_stocking_places'); ?></a>
  ...
  <div class="row">
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <a href="<?= base_url('user/admin/modify_stocking_place').'/'.$stocking_place->stocking_place_id ?>" style="display:block"><?= html_escape($stocking_place->short); ?></a>
          </td>
          <td>
            <?= html_escape($stocking_place->name); ?>
          </td>
          <td>
            <a href="<?= base_url('user/admin/delete_stocking_place').'/'.$stocking_place->stocking_place_id ?>"
