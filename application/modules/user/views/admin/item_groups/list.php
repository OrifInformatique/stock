<div class="container" id="content">
  <div class="row">
    <a href="<?= base_url(); ?>user/admin/new_item_group/" class="btn btn-success"><?= lang('btn_new'); ?></a>
  </div>
  ...
  <div class="row">
    <h3>
      ...
      <a href="#" onclick="loadPage('user/admin/view_item_groups/')" class="tab_selected"><?= lang('admin_tab_item_groups'); ?></a>
    </h3>
  </div>
  ...
  <div class="row">
    <table class="table table-striped table-hover">
      <tbody>
        ...
        <tr>
          <td>
            <a href="<?= base_url(); ?>user/admin/modify_item_group/<?= $item_group->item_group_id; ?>"><?= html_escape($item_group->name); ?></a>
            <span class=".text-center"><?= html_escape($item_group->short_name); ?></span>
            <a href="<?= base_url(); ?>user/admin/delete_item_group/<?= $item_group->item_group_id; ?>" class="close"
