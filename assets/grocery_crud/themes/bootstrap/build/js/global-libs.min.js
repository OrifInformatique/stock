...
}, CacheLibrary.prototype.setLocalStorageItem = function () {
}, CacheLibrary.prototype.removeLocalStorageItem = function () {
}, CacheLibrary.prototype.getLocalStorageItem = function () {
    return null
...
jQuery(function (a) {
    var b;
    "true" === CacheLibrary.getLocalStorageItem("gcrud_fullscreen") && (a(".gc-full-width").find("i.fa:first").toggleClass("fa-expand"), a(".gc-full-width").find("i.fa:first").toggleClass("fa-compress"), a(".gc-container").addClass("container-full no-transition"), setTimeout(function () {
        a(".gc-container").removeClass("no-transition")
    }, 400)), a(".gc-full-width").click(function () {
        if (a(this).find("i.fa:first").toggleClass("fa-expand"), a(this).find("i.fa:first").toggleClass("fa-compress"), a(this).closest(".gc-container").hasClass("container-full")) {
            a(this).closest(".gc-container").removeClass("container-full");
            var c = a(this).closest(".gc-container").offset().top - 10;
            return a("html,body").animate({scrollTop: c}, 750), CacheLibrary.setLocalStorageItem("gcrud_fullscreen", "false"), !0
        }
        b = a(this).closest(".gc-container").offset(), a(this).closest(".gc-container").css("left", b.left + "px").css("top", b.top + "px").addClass("container-before-resize"), a("html,body").animate({scrollTop: "0"}, 750), a(this).closest(".gc-container").removeClass("container-before-resize").removeAttr("style").addClass("container-full"), CacheLibrary.setLocalStorageItem("gcrud_fullscreen", "true")
    }), a(".minimize-maximize").click(function () {
        a(this).find("i").toggleClass("fa-caret-down"), a(this).find("i").toggleClass("fa-caret-up"), a(this).closest(".gc-container").find(".table-container:first").slideToggle("slow")
    }), a(".gc-full-width").hover(function () {
        a(this).find("i.fa:first").addClass("fa-lg")
    }, function () {
        a(this).find("i.fa:first").removeClass("fa-lg")
    })
});