                ...
                <table class="table table-bordered grocery-crud-table table-hover">
                    ...
                    <tr>
                        ...
                        <?php foreach ($columns as $column) { ?>
                            <th class="column-with-ordering"
                                data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                        <?php } ?>
                    </tr>
                    ...
                    <tr class="filter-row gc-search-row">
                        ...
                        <?php foreach ($columns as $column) { ?>
                            <td>
                                <input type="text" class="form-control searchable-input floatL"
                                       placeholder="Search <?php echo $column->display_as; ?>"
                        ...
                        <td colspan="<?php echo $colspans; ?>">
                            ...
                            <div class="floatR r5">
                                ...
                                <ul class="pagination">
                                    ...
                                    <li class="next paging-next"><a href="#"><i class="fa fa-chevron-right"></i></a>
                                    </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
                        <button type="button"
                                class="btn btn-danger delete-confirmation-button"><?php echo $this->l('list_delete'); ?></button>
                    </div>
                </div>
            </div>
        </div>
